    ...
    >
      ...
      <div className="absolute z-20 bottom-0 left-0 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-between gap-4 pb-6 md:pb-8">
            {/* Dots / indicadores — centrados en móvil */}
            ...
            {/* Flechas — ocultas en móvil para evitar colisión con botón flotante */}
